        ...
        <section className="section-container">
            ...
            <div className="flex flex-row mt-10">
                <div className="flex flex-col mt-10 mr-5 w-1/2 items-end">
                    <div className="border-white border-[2px] w-full lg:w-3/5 p-10 mb-5 text-center">
                        <p className="text-white text-lg lg:text-2xl capitalize">Range Of Styles</p>
                    </div>

                    <div className="border-white border-[2px] w-full lg:w-1/2 p-10 text-center">
                ...
                <div className="flex flex-col w-[49%] items-start">
                    <div className="border-white border-[2px] w-full lg:w-1/2 p-10 mb-5 text-center">
                        <p className="text-white text-lg lg:text-2xl capitalize">Endless Experiences</p>
                    </div>

                    <div className="border-white border-[2px] w-full lg:w-3/5 p-10 text-center">
